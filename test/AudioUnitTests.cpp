...
TEST_CASE("Concatanate test"){
    ...
    SECTION("Mono test"){
        ...
        string testFile = "expectedOutputForTests/ConcatenTest_44100_8_mono.raw";
    ...
    SECTION("Stereo test"){
        ...
        string testFile = "expectedOutputForTests/ConcatenTestS_44100_16_stereo.raw";
...
TEST_CASE("Volume test"){
    SECTION("Mono test"){
        ...
        string testFile = "expectedOutputForTests/VolumeTest_44100_8_mono.raw";
    ...
    SECTION("Stereo test"){
        ...
        string testFile = "expectedOutputForTests/VolumeTestS_44100_16_stereo.raw";
...
TEST_CASE("Addition test"){
    SECTION("Mono test"){
        ...
        string testFile = "expectedOutputForTests/AdditionTest_44100_8_mono.raw";
        Audio<int8_t> expectedAudio = Audio<int8_t>(testFile,channel,rate);
    ...
    SECTION("Stereo test"){
        ...
        string testFile = "expectedOutputForTests/AdditionTestS_44100_16_stereo.raw";
        Audio<pair<int16_t,int16_t>> expectedAudio = Audio<pair<int16_t,int16_t>>(testFile,channe2,rate2);
...
TEST_CASE("Cut out test"){
    SECTION("Mono test"){
        ...
        string testFile = "expectedOutputForTests/CutOutTest_44100_8_mono.raw";
        Audio<int8_t> expectedAudio = Audio<int8_t>(testFile,channel,rate);
    ...
    SECTION("Stereo test"){
        ...
        string testFile = "expectedOutputForTests/CutOutTestS_44100_16_stereo.raw";
        Audio< pair<int16_t,int16_t>> expectedAudio = Audio<pair<int16_t,int16_t>>(testFile,channel,rate);
...
TEST_CASE("Reverse test"){
    SECTION("Mono"){
        ...
        string testFile = "expectedOutputForTests/Reversed_44100_8_mono.raw";
        Audio<int8_t> expectedAudio = Audio<int8_t>(testFile,channel,rate);
    ...
    SECTION("Stereo"){
        ...
        string testFile = "expectedOutputForTests/ReversedS_44100_16_stereo.raw";
        Audio< pair<int16_t,int16_t>> expectedAudio = Audio<pair<int16_t,int16_t>>(testFile,channel,rate);
...
TEST_CASE("Range added test"){
    SECTION("Mono test"){
        ...
        string testFile = "expectedOutputForTests/RangeAdded_44100_8_mono.raw";
        Audio<int8_t> expectedAudio = Audio<int8_t>(testFile,channel,rate);
    ...
    SECTION("Stereo test"){
        ...
        string testFile = "expectedOutputForTests/RangeAddedS_44100_16_stereo.raw";
        Audio<pair<int16_t,int16_t>> expectedAudio = Audio<pair<int16_t,int16_t>>(testFile,channel,rate);
...
TEST_CASE("Compute RMS test"){
    SECTION("Mono test"){
        ...
        string rmsStringCalc = to_string(calculatedRMS);

        float expectedRMS = 5.77678585;
        string rmsStringExp = "5.776786";

        REQUIRE(rmsStringExp == rmsStringCalc);
    }
    SECTION("Stereo test"){
        string fileName = "../sample_input/beez18sec_44100_signed_16bit_stereo.raw";
        int channel = 2;
...
TEST_CASE("Normalization test"){
    SECTION("Mono test"){
        ...
        string testFile = "expectedOutputForTests/NormalisedTest_44100_8_mono.raw";
        Audio<int8_t> expectedAudio = Audio<int8_t>(testFile,channe2,rate2);
    ...
    SECTION("Stereo test"){
        ...
        string testFile = "expectedOutputForTests/NormalisedTestS_44100_16_stereo.raw";
        Audio<pair<int16_t,int16_t>> expectedAudio = Audio<pair<int16_t,int16_t>>(testFile,channel,rate);
...
TEST_CASE("Fading test - EXTRA CREDIT"){
    SECTION("Fade IN"){
        SECTION("Mono"){
            ...
            string testFile = "expectedOutputForTests/FadeInTest_44100_8_mono.raw";
            Audio<int8_t> expectedAudio = Audio<int8_t>(testFile,channe2,rate2);
        ...
        SECTION("Stereo"){
            ...
            string testFile = "expectedOutputForTests/FadeInTestS_44100_16_stereo.raw";
            Audio<pair<int16_t,int16_t>> expectedAudio = Audio<pair<int16_t,int16_t>>(testFile,channel,rate);
    ...
    SECTION("Fade Out"){
        SECTION("Mono"){
            ...
            string testFile = "expectedOutputForTests/FadeOutTest_44100_8_mono.raw";
            Audio<int8_t> expectedAudio = Audio<int8_t>(testFile,channe2,rate2);
        ...
        SECTION("Stereo"){
            ...
            string testFile = "expectedOutputForTests/FadeOutTestS_44100_16_stereo.raw";
            Audio<pair<int16_t,int16_t>> expectedAudio = Audio<pair<int16_t,int16_t>>(testFile,channel,rate);
